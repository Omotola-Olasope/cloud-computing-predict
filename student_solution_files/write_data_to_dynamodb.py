...
def lambda_handler(event, context):
    ...
    # This variable will be used as our key value 
    # i.e the ResponsesID and should be of type integer.
    ...
    rid = random.randint(101, 1000000)
    # -----------------------------
    ...
    # Remember pass the name of the DynamoDB table created in step 4
    table = dynamodb.Table('omotolas_portfolio_data_table')
